function hide() {
  var added_item_button = document.getElementById('link');
  var actualDisplay = getComputedStyle(added_item_button).display;
  var added_item_button_1 = document.getElementById('links');
  var actualDisplay_1 = getComputedStyle(added_item_button_1).display;
	if (actualDisplay == 'flex') {
		added_item_button.style.display = 'none';
		added_item_button_1.style.display = 'block';
	}
}
